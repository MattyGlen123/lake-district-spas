...
export const spa13Treatments: Treatment[] = [
  ...
  {
    spaId: 13,
    name: 'Elemis Lime And Ginger Salt Glow Or Frangipani Scrub',
    description:
      'Feel invigorated, cleansed, and polished to perfection. A body exfoliation ritual to invigorate and revitalise. After light body brushing, warm oil is dripped luxuriously over the body before the sublime Elemis Exotic Lime & Ginger Salt Glow is applied. Skin is deeply cleansed and moisturised, leaving it glowing and vibrant, replenished, and flawless. This also includes a mini facial.',
    shortDescription:
