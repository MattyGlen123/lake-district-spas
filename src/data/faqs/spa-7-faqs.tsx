    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <Link href="#low-wood-bay-weekday-thermal-lunch" className="underline">
            Weekday Thermal Journey with Lunch or Afternoon Tea
          </Link>{' '}
          starts at {weekdayThermalLunchPrice || '£125'}, or the{' '}
          <Link href="#low-wood-bay-weekend-thermal-lunch" className="underline">
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <Link href="#low-wood-bay-weekday-ultimate-dine" className="underline">
            Ultimate Spa & Dine
          </Link>{' '}
