...
export function getSpa14FAQs(spa: Spa): FAQ[] {
  // Day pass prices
  const dayMembershipTreatmentPrice = getDayPassPrice(
    spa.id,
  ...
  return [
    {
      ...
      answer: (
        <>
          ...
          active relaxation rather than traditional thermal experiences. At its
          heart is a stunning 20 metre indoor pool with floor-to-ceiling glass
          walls and views across Ullswater to the fells beyond. The pool uses
          ultra violet filtered, low chlorine water and includes a shallow area
          for children.
          <br />
          <br />
          Beyond the pool, the Swim Club includes an outdoor Swedish style hot
          tub overlooking the grounds, a sauna with lake views, treatment rooms
          offering massages and facials, and a cardio room with running
          machines. The hot tub and sauna are for guests aged 16 and over only.
          While it lacks the extensive thermal suite found at destination spas,
          the Swim Club offers a more casual, activity focused approach that
          complements the hotel&apos;s outdoor lifestyle positioning.
          <br />
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          Day membership at {spa.name} Swim Club starts from{' '}
          {dayMembershipTreatmentPrice || '£110'} per person with the{' '}
          <Link
            href="#another-place-day-membership-treatment"
            className="underline"
          >
          ...
          giving ongoing access to the pool, hot tub, sauna, and cardio room.
          View all{' '}
    ...
    },
    {
      ...
      answer: (
        <>
          Yes, Swim Club access is complimentary for all hotel guests at{' '}
          {spa.name}, regardless of which room type you book. This includes the
          20 metre lake view swimming pool, outdoor hot tub, sauna, and cardio
          room. There is no extra charge and no time limit on your access during
          opening hours (7am to 9pm daily).
          <br />
          <br />
          This makes {spa.name} different from some Lake District spa hotels
          where spa access costs extra or is only included for premium room
          bookings. You can even use the Swim Club facilities before your room
          is ready (check in is at 3pm) and after check out (11am), making the
          most of your visit.
          <br />
          <br />
          Only spa treatments require separate booking and payment. The hot tub
          and sauna are restricted to guests aged 16 and over. For full details,
          see the{' '}
    ...
    },
    {
      ...
      answer: (
        <>
          Yes, children are welcome in the Swim Club pool at {spa.name} during
          family swim times from 9am to 6pm daily. The 20 metre pool has a
          shallow area specifically designed for younger swimmers. However, the
          outdoor hot tub and sauna are restricted to guests aged 16 and over at
          all times for safety reasons.
          <br />
          <br />
          For couples or adults seeking a quieter experience, dedicated adult
          only swim times run from 7am to 9am and 6pm to 9pm. These early
          morning and evening slots offer a more tranquil atmosphere without
          children in the pool area.
          <br />
          <br />
          {spa.name} also offers a separate Ofsted registered Kids Zone with
          supervised sessions, arts and crafts, campfire cooking, and outdoor
          activities, giving parents time to enjoy the spa while children are
          entertained. For adults only spa alternatives in the Lake District,
          browse our{' '}
    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <Link
            href={fellWalkersId ? `#${fellWalkersId}` : '#treatments'}
            className="underline"
          >
          ...
          <Link
            href={fullBodyMassageId ? `#${fullBodyMassageId}` : '#treatments'}
            className="underline"
          >
            full body massage
          </Link>{' '}
          ...
          <Link
            href={worksId ? `#${worksId}` : '#treatments'}
            className="underline"
          >
            The Works
          </Link>{' '}
          ...
          For couples,{' '}
          <Link
            href={sideBySideId ? `#${sideBySideId}` : '#treatments'}
            className="underline"
          >
