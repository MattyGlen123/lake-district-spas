...
export function getSpa3FAQs(spa: Spa): FAQ[] {
  ...
  const spaSensesId = getTreatmentIdByName(spa.id, 'Spa Senses Signature Ritual - Detoxifying');
  ...
  return [
    {
      ...
      answer: (
        <>
          No, {spa.name} is exclusively available to hotel guests. Unlike many Lake District spas, Brimstone does not offer day passes or spa day packages. The spa facilities are reserved solely for guests staying at the hotel, creating an intimate and tranquil environment throughout your visit.
          <br />
          <br />
          This exclusive approach means the spa never feels overcrowded, and hotel guests can enjoy unlimited access to all facilities throughout their stay. From the moment you arrive until check out, you can use the 9 metre swim through pool, {thermalCount} thermal experiences, and relaxation areas as often as you wish without booking time slots or worrying about capacity limits.
          <br />
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          Yes, spa access is complimentary for all hotel guests at {spa.name} regardless of which room type you book. From your arrival until check out, you have unlimited access to all spa facilities including the unique 9 metre swim through indoor and outdoor pool, {thermalCount} thermal experiences, relaxation areas, and the outdoor terrace with views over the Langdale Pikes.
          <br />
          <br />
          Unlike some Lake District spas that operate on timed booking slots, {spa.name} allows guests to come and go as they please throughout their stay. You can use the spa facilities first thing in the morning, between activities, or for a relaxing evening session. The spa is even available while you wait for your room to be ready on arrival, so you can start unwinding from the moment you arrive.
          <br />
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          {spa.name} stands out in the Lake District for its distinctive Scandinavian inspired design and several unique features you won&apos;t find elsewhere. The centrepiece is the 9 metre swim through pool that connects the indoor spa directly to the outdoor terrace, allowing you to swim between warm waters while taking in views of the surrounding Langdale fells. This is the only swim through pool of its kind in the Lake District.
          <br />
          <br />
          Beyond the pool, guests enjoy {thermalCount} thermal experiences including a traditional Finnish sauna, laconium (gentle dry heat room), aromatic steam room infused with essential oils, an ice room for contrast therapy, and multi sensory experience showers. The spa uses exclusive Pure Alchemy products, a range developed specifically for Brimstone using natural Lake District elements.
          <br />
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          {spa.name} offers 27 spa treatments ranging from express 25 minute therapies to indulgent 100 minute signature rituals. The treatment menu features two premium brands: Pure Alchemy, an exclusive range developed specifically for Brimstone using Lake District natural elements, and Skeyndor, a professional skincare line known for advanced facial treatments.
          <br />
          <br />
    ...
    },
    {
      ...
      answer: (
        <>
          Yes, {spa.name} is exclusively for guests aged {agePolicy || '18 and over'}. The spa facilities including the swim through pool, all thermal experiences, and relaxation areas are restricted to adult guests only. This policy is in place due to the nature of the thermal heat experiences (saunas, steam rooms, laconium) which are unsuitable for children, and to maintain a peaceful, relaxing atmosphere for all visitors.
          <br />
          <br />
          While the spa is adults only, families with children are welcome to stay at the wider Langdale Estate, which includes the adjacent Langdale Hotel. However, children cannot access the Brimstone spa facilities under any circumstances. If you&apos;re travelling with younger guests, be aware that the spa experience will only be available to adult members of your party.
          <br />
          <br />
