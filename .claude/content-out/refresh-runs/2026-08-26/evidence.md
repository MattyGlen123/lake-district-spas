...
- **Artifact:** `.claude/content-out/refresh-runs/2026-08-26/spa-12.html` — 5 fetched page(s), bundled and trimmed to the quoted spans
  - 148 KB → 26 KB (**83% smaller**), 10/10 gate verdicts verified identical to the full pages by `trim-artifact.mjs`
  - all fetches HTTP 200 — per-page logs in `spa-12-fetch-log.json`
- **Gate results:** `.claude/content-out/refresh-runs/2026-08-26/spa-12-gate-results.json` · **Checks:** `spa-12-checks.json`
...
- **Artifact:** `.claude/content-out/refresh-runs/2026-08-26/spa-19.html` — 7 fetched page(s), bundled and trimmed to the quoted spans
  - 235 KB → 40 KB (**83% smaller**), 7/7 gate verdicts verified identical to the full pages by `trim-artifact.mjs`
  - all fetches HTTP 200 — per-page logs in `spa-19-fetch-log.json`
- **Gate results:** `.claude/content-out/refresh-runs/2026-08-26/spa-19-gate-results.json` · **Checks:** `spa-19-checks.json`
- **Fetch timestamp:** 2026-08-26 21:06 BST
