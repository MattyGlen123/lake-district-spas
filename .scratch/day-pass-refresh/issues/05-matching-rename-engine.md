...
- `npm run typecheck && npm test` green (707 tests, 43 files, incl. `priced-content.test.ts` and the new suites). Draft PR: #TBD on branch `refresh/05-matching-rename-engine`.
