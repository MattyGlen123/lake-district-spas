...
- `npm run typecheck && npm test` green (717 tests, 44 files — up from 707/43 on the 05 base). Draft PR: [#24](https://github.com/MattyGlen123/lake-district-spas/pull/24) on branch `refresh/06-successor-suggestions`, based on `refresh/05-matching-rename-engine`.
